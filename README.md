...
|---|---|---|---|---|
| 00 | Cahier des charges | Claude Docs, export PDF | `00_CahierDesCharges` | Terminé (v1.1) |
| 01 | Bilan de puissance | Excel | `01_BilanPuissance` | Terminé (v4) |
...
| J2 | Machines choisies, bilan de puissance | Terminé |
